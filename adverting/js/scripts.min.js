...
$(function(){$(document).ready(function(){$("iframe").mediaWrapper({intrinsic:!0,baseWidth:16,baseHeight:9})}),$(document).ready(function(){$("#owl-demo").owlCarousel({slideSpeed:300,paginationSpeed:400,dots:!1,nav:!0,items:1,loop:!0,smartSpeed:450,itemsDesktop:!1,itemsDesktopSmall:!1,itemsTablet:!1,itemsMobile:!1}),$(".overlay").click(function(){$(this).remove()})})});